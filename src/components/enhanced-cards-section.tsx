...
const cardData = [
  ...
  {
    title: "Xây dựng hiện nay",
    description: "Vận dụng tư tưởng Hồ Chí Minh trong thời kỳ hiện nay",
    icon: "✨",
    href: "/timeline",
    ...
    <section className="py-32 px-4 relative overflow-hidden">
      ...
      <div className="container mx-auto relative z-10">
        <motion.div
          ...
          viewport={{ once: true }}
        >
          <h2 className="text-5xl font-bold mb-8 text-foreground text-transparent bg-clip-text bg-gradient-to-r from-primary to-secondary leading-relaxed">
            Khám Phá Tư Tưởng Hồ Chí Minh
          </h2>
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
            Tìm hiểu những khía cạnh quan trọng của tư tưởng Hồ Chí Minh về văn
            hóa, đạo đức và con người qua các chủ đề
          </p>
        </motion.div>
