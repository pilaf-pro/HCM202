            ...
            >
              ...
              >
                ...
                >
                  ...
                  >
                    Con người là trung tâm, là mục tiêu và động lực của sự phát
                    triển
                  </motion.div>
                  ...
                  >
                    {[
                      { k: "Văn hóa", v: "Dân tộc • Khoa học • Đại chúng" },
                      { k: "Đạo đức", v: "Cần • Kiệm • Liêm • Chính" },
                      { k: "Con người", v: "Toàn diện • Tự do • Sáng tạo" },
                      { k: "Giáo dục", v: "Đức • Trí • Thể • Mỹ" },
                      { k: "Văn học", v: "Phục vụ nhân dân" },
                      { k: "Nghệ thuật", v: "Dân tộc hóa" },
                    ].map((item) => (
                      <div
                        key={item.k}
              ...
              >
                <div className="text-center">
                  <div className="text-xs text-red-600 font-bold">HỒ CHÍ</div>
                  <div className="text-xs text-red-600 font-bold">MINH</div>
                </div>
              </motion.div>
            </motion.div>

            {/* Floating keywords */}
            {["VH", "ĐĐ", "CN", "HCM"].map((symbol, i) => (
              <motion.div
                key={i}
